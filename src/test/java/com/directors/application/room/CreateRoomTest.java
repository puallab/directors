...
class CreateRoomTest extends RoomTestSupport {
	...
	void createRoom() {
		...
		User questioner = createUser("cnsong123", "1234567890", "thddmstjrwkd@naver.com", "01077021045", "송은석",
			"cnsong");
		...
		Question question =
			createQuestion("원하는 질문", "질문 내용은 ~~~입니다.", savedDirector, savedQuestioner, SpecialtyProperty.ART,
				savedSchedule);
